...
| **[Attachments Handling](./whatsapp-eum-connect-chat/README.md)** | Processes WhatsApp media attachments (images, documents, audio) with S3 storage, format conversion, and secure delivery to Amazon Connect agents. Connect attachments delivered to Whatsapp Users | CDK Python |
| **Outbound Messaging** *(Coming Soon)* | WhatsApp messages to customers from Amazon Connect agent Workspace | CDK Python
