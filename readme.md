...
If you want to test this use cases, unless stated otherwise, follow this guide: [General Prerequisites for Amazon Connect and End User Messaging](general_connect_eum.md)
